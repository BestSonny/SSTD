...
class DetectionOrientedOutputLayer : public Layer<Dtype> {
 public:
  explicit DetectionOrientedOutputLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
 ...
 protected:
   ...
   *   -# @f$ (N \times C1 \times 1 \times 1) @f$
   *      the location predictions with C4 predictions.
   * @param top output Blob vector (length 1)
   *   -# @f$ (1 \times 1 \times N \times 7+5) @f$
