...
class DataTransformer {
 public:
  ...
  void setMirror(bool mirror_flag);
  void setForceMirrorFlag(bool force_mirror_flag);
  bool getMirror();
  /**
  ...
  *
  * @param anno_datum
  *    AnnotatedMaskDatum containing the data, mask and annotation to be transformed.
  * @param transformed_blob
  *    This is destination blob. It can be part of top blob's data if
  *    set_cpu_data() is used. See annotated_data_layer.cpp for an example.
  * @param transformed_anno_vec
  *    This is destination annotation.
  */
 void Transform(const AnnotatedMaskDatum& anno_datum,
                Blob<Dtype>* transformed_blob,
                RepeatedPtrField<AnnotationGroup>* transformed_anno_vec, bool mask);
 void Transform(const AnnotatedMaskDatum& anno_datum,
                Blob<Dtype>* transformed_blob,
                RepeatedPtrField<AnnotationGroup>* transformed_anno_vec,
  ...
  * @brief Crops the datum and AnnotationGroup according to bbox.
  */
  void CropImage(const AnnotatedMaskDatum& anno_datum, const NormalizedBBox& bbox,
              AnnotatedMaskDatum* cropped_anno_datum,  bool mask);
   /**
