...
EXCLUDES := $(shell find  $(EXCLUDES_FOLDERS) -name '*.cpp')
EXAMPLE_SRCS := $(filter-out $(EXCLUDES),$(EXAMPLE_SRCS))
...
ifeq ($(USE_OPENCV), 1)
	LIBRARIES += opencv_core opencv_highgui opencv_imgproc opencv_imgproc opencv_imgcodecs opencv_videoio
